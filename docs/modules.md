...
Откатил все изменения, связанные с модулями, и вернулся к h-файлам. Проблемы и неудобства пока что явно перевешивают полезность
модулей. Лет через пять попробую еще раз.

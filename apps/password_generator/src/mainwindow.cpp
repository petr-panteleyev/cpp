...
void visualizeOptions(Ui::MainWindow *ui, const pwdgen::PasswordGeneratorOptions &options) {
...
void generate(Ui::MainWindow *ui, const pwdgen::PasswordGeneratorOptions &options) {
...
MainWindow::MainWindow(QWidget *parent) : QMainWindow(parent), ui(std::make_unique<Ui::MainWindow>()) {
    ...
    connect(ui->actionGenerate, &QAction::triggered, [this]() {
        ::generate(ui.get(), pwdgen::PasswordGeneratorOptions{

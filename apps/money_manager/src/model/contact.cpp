...
Contact::Contact(QUuid uuid, const QString &name, const ContactType &type, const QString &phone, const QString &mobile,
    ...
    : MoneyRecord{uuid, created, modified}, name_{name}, type_{type}, phone_{phone}, mobile_{mobile}, email_{email},
      web_{web}, comment_{comment}, street_{street}, city_{city}, country_{country}, zip_{zip}, iconUuid_{iconUuid} {
}
